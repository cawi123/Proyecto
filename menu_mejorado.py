...
class Menu:
    print("Representa un menú con opciones para un juego")
    ...
    def actualizar(self):
        #print("Altera el valor de 'self.seleccionado' con los direccionales.")
    ...
    def imprimir(self, screen):
        #print("Imprime sobre 'screen' el texto de cada opción del menú.")
